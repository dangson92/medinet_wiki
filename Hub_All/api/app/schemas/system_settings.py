...
Thông báo). Frontend gửi MỌI giá trị dạng string (`String(bool)` cho toggle) →
tất cả field là `str`. Mọi field optional: PUT là partial update — chỉ field
gửi lên (non-None) mới được persist.
"""
...
class UpdateSystemSettingsRequest(BaseModel):
    """Body PUT /api/system-settings — 8 key khớp Settings.tsx."""
