...
next_action: "/gsd-discuss-phase 1 — ROLE migration (Alembic role_enum + user_hubs.role column)"
---
...
|-------|------|-----------|--------|------------------|--------|
| 1 | DB schema | role_enum mở rộng + user_hubs.role column + helper + seed migration | ROLE-01..04 (4) | 3-4 | Not started |
