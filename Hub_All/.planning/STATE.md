...
| Last activity | 2026-05-13 — Plan 02-02 complete: 10 SQLAlchemy models (Base.metadata.tables = 10) — 8 files, 7 commits. HNSW vector_cosine_ops + Vector(1536) + status CHECK enum failed_unsupported đầy đủ. |
