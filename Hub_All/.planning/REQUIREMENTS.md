...
| COMPAT-01 | Phase 8 (frontend smoke 12 pages + replay test + VN filename) | 🔄 In progress — Plan 08-01 done (contract diff + replay test tĩnh, SC3 thoả); còn 08-02 fix api-side + 08-03 test suite + 08-04 smoke 11 trang |
