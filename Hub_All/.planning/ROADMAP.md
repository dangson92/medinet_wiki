...
- [ ] **Phase 9: Eval Framework + Quality Gate ≥75% top-3** — pytest-based eval + 10 file VN medical + queries.jsonl + gate (Plan 09-01 + 09-02 ✅ 2026-05-21 foundation + lib/metrics, 3/5 plans còn lại)
