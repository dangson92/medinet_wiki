...
- [ ] **Phase 9: Eval Framework + Quality Gate ≥75% top-3** — pytest-based eval + 10 file VN medical + queries.jsonl + gate (Plan 09-01 + 09-02 + 09-03 + 09-04 ✅ 2026-05-21 framework end-to-end runnable `make eval-smoke` + `make eval-all`, 1/5 plan còn lại — Plan 09-05 Wave 4 gate verdict thật)
...
| 9. Eval Framework + Quality Gate ≥75% top-3 | 4/5 | In progress (Wave 1+2+3: 09-01 ✅ foundation, 09-02 ✅ lib+metrics, 09-03 ✅ report+gate, 09-04 ✅ orchestrator+Makefile+README — framework end-to-end runnable) | - |
| 10. Hardening + Observability + Docs | 0/? | Not started | - |

**Tổng:** 11/14 phases complete (M2a: 4/4 ✅ — Phase 1/2/3/4 done · M2b: 7/10 — Phase 5/6/7/8/8.1/8.2/8.3 done · Phase 9 IN PROGRESS 4/5 plans (09-01 + 09-02 + 09-03 + 09-04 ✅ framework end-to-end runnable) · Phase 10 pending). M2a EXIT GATE ✅ PASSED 2026-05-21.
